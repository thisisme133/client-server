...
// ============================================================================
// PROTECTED FUNCTIONS - Définitions pour exécution côté serveur
// Ces fonctions sont téléchargées du serveur sous forme de bytecode
// ============================================================================

// ANTI-DEBUG: Détecte la présence d'un debugger (5 méthodes)
...
// ANTI-VM: Détecte la présence d'une machine virtuelle (4 méthodes)
...
// PROCESS ENUMERATION: Trouve le PID d'un processus par son nom
...
// PE VALIDATION: Valide les headers PE
...
// PE INJECTION: Injection complète PE dans un processus distant
